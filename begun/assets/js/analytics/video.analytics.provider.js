...
(function () {
    ...
    VideoAnalyticsProvider.prototype._onLoad = function () {
        ...
        var contextData = {
            ...
            tvStation: "Studio Technology",
            programmer: "Marvel Studios"
        };
        
        // Set standard Video Metadata        
        contextData[Media.VideoMetadataKeys.Episode] = "Microsite Video";
        contextData[Media.VideoMetadataKeys.Show] = "Jambalaya";
    ...
    VideoAnalyticsProvider.prototype._onChapterStart = function () {
        ...
        var chapterInfo = Media.createChapterObject(_chapterInfo.name, _chapterInfo.position, _chapterInfo.length, _chapterInfo.startTime);
